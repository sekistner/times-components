...
const SecondaryFour = ({secondary1, secondary2, secondary3, secondary4}) => (
    <SecondaryFourSlice
       renderSecondary1={() => (<PrimaryTile tile={secondary1} withImagePosition="top" />)}
       renderSecondary2={() => (<PrimaryTile tile={secondary2} withImagePosition="top" />)}
       renderSecondary3={() => (<PrimaryTile tile={secondary3} withImagePosition="top" />)}
       renderSecondary4={() => (<PrimaryTile tile={secondary4} withImagePosition="top" />)}
    />
);
